...
public class AnalyzeByStandard extends BaseClassOne{
	...
	public void TCED14124() 
	{
		try
		{
			...
			//To click on the Beta Summary reports(Analyze By Standard New)
			click("//*[@id='ctl00_MainContent_hlnkAnalyzeByStandardNew']");
