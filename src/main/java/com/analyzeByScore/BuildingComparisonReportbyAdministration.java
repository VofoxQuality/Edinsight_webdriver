...
public class BuildingComparisonReportbyAdministration extends BaseClassOne {
	
	@Test(priority=1)
	public void TCED14248() 
	{
		try
		{
			...
			//To click on the Building Comparison Report by Administration
	...
	public void TCED14251()
	{
		try
		{
			...
			//To click on the Analyze by Standard
			click("//*[@id='ctl00_MainContent_rbStandard']");
	...
	public void TCED14258()
	{
		try
		{
			...
			//To click on run Report
			click("//*[@id='ctl00_MainContent_btnRunReport']");
			
			//click on the radio button analyze by building.
			click("//*[@id='ctl00_MainContent_rbBuilding']");
			
			//To delete all the files in the directory
			FileDelete();
			
			//To click on the Print ot PDF
			click("//*[@id='ctl00_MainContent_btnPrintToPDFDetailed']");
			Thread.sleep(3000);
	...
	//To Check the functionality "Click Here To See Test" in the Analyze by Question Report.
	@Test(priority=8)
	public void TCED14261()
	{
		try
		{
