...
public class Misconduct extends BaseClassOne{
	

	@Test(priority=1)
	public void TCED34403() 
	{
		try
		{
			//Supertent Login
			...
			click("//span[contains(text(),'misconduct')]");	
			
			//To delete all the files in the directory
			FileDelete();
			
			//To click on the Print ot PDF
			click("//input[@id='ctl00_MainContent_StudentDisplayMisconduct1_btnPrintToPDF']");
			Thread.sleep(4000);
