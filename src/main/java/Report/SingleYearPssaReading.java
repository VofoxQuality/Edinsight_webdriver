...
public class SingleYearPssaReading extends BaseClassOne
{
	@Test(priority=1)
	public void TCED381601()
	{
		try
		{
			//Supertent Login
			...
			click("//a[contains(text(),'Single Year PSSA Reading')]");
			
			//Assert the the Header Name as Longitudinal PSSA Reading Analysis
			Assert.assertEquals(getText("//td[@class='header-txt']"),"Single Year PSSA Reading Anchor Analysis");				
		} 
		catch (Exception e)
		{
	...
	public void TCED381604()
	{
		try
		{
			...
			//Assert the the Header Name as Single Year PSSA Reading Anchor Analysis
			Assert.assertEquals(getText("//span[@class='administitle']"),"Single Year PSSA Reading Anchor Analysis");				
		} 
		catch (Exception e)
		{
			Assert.fail(e.getMessage());
	...
	public void TCED381505()
	{
		try
		{
			...
			Assert.assertEquals(getText("//td[@class='InputGeneral']//span[2]"),"E.A - Literature Text");
			
			// Assert the Labels:-M.A-N.1 - Demonstrate an understanding of rational and irrational numbers.
			Assert.assertEquals(getText("//td[@class='InputGeneral']//span[3]"),"E.A-C.2 - Craft and Structure");
			
			//Assert the Labels:-E.A-C.3 - Integration of Knowledge and Ideas
			Assert.assertEquals(getText("//td[@class='InputGeneral']//span[4]"),"E.A-C.3 - Integration of Knowledge and Ideas");
			
			//Assert the Labels:-E.A-K.1 - Key Ideas and Details
			Assert.assertEquals(getText("//td[@class='InputGeneral']//span[5]"),"E.A-K.1 - Key Ideas and Details");
			
			// Assert the Labels:-E.A-V.4 - Vocabulary Acquisition and use
			Assert.assertEquals(getText("//td[@class='InputGeneral']//span[6]"),"E.A-V.4 - Vocabulary Acquisition and use");
			
			// Assert the Labels:-E.B - Informational Text
			Assert.assertEquals(getText("//td[@class='InputGeneral']//span[7]"),"E.B - Informational Text");
			
			// Assert the Labels:E.B-C.2 - Craft and Structure
			Assert.assertEquals(getText("//td[@class='InputGeneral']//span[8]"),"E.B-C.2 - Craft and Structure");
			
			// Assert the Labels:-E.B-C.3 - Integration of Knowledge and Ideas
			Assert.assertEquals(getText("//td[@class='InputGeneral']//span[9]"),"E.B-C.3 - Integration of Knowledge and Ideas");
			
			//Assert the Labels:-B-K.1 - Key Ideas and Details
			Assert.assertEquals(getText("//td[@class='InputGeneral']//span[10]"),"E.B-K.1 - Key Ideas and Details");
						
			// Assert the Labels:-E.A-V.4 - Vocabulary Acquisition and use
			Assert.assertEquals(getText("//td[@class='InputGeneral']//span[11]"),"E.B-V.4 - Vocabulary Acquisition and Use");
			
			// Assert the Labels:-E.B - Informational Text
			Assert.assertEquals(getText("//td[@class='InputGeneral']//span[12]"),"E.C - Writing");
			
			// Assert the Labels:-E.C.2 - Text Types and Purposes
			Assert.assertEquals(getText("//td[@class='InputGeneral']//span[13]"),"E.C.1 - Text Types and Purposes");
			
			// Assert the Labels:-E.B-C.3 - Integration of Knowledge and Ideas
			Assert.assertEquals(getText("//td[@class='InputGeneral']//span[14]"),"E.D - Language");
			
			// Assert the Labels:E.D.1 - Conventions of Standard English
			Assert.assertEquals(getText("//td[@class='InputGeneral']//span[15]"),"E.D.1 - Conventions of Standard English");
			
			// Assert the Labels:E.D.2 - Knowledge of Language
			Assert.assertEquals(getText("//td[@class='InputGeneral']//span[16]"),"E.D.2 - Knowledge of Language");
			
			// Assert the Labels:E.D.2 -E.E - Text-Dependent Analysis
			Assert.assertEquals(getText("//td[@class='InputGeneral']//span[17]"),"E.E - Text-Dependent Analysis");
			
			// Assert the Labels:E.E.1 - Evidence-Based Analysis of Text
			Assert.assertEquals(getText("//td[@class='InputGeneral']//span[18]"),"E.E.1 - Evidence-Based Analysis of Text");
		} 
		catch (Exception e)
		{
			Assert.fail(e.getMessage());
	...
	public void TCED381510()
	{
		try
		{
			...
			type("//*[@id='ctl00_MainContent_ctl02_rdgStudentScores_ctl00_ctl02_ctl01_FilterTextBox_ReadScaledScore']","928");
			click("//*[@id='ctl00_MainContent_ctl02_rdgStudentScores_ctl00_ctl02_ctl01_Filter_ReadScaledScore']/span");
			click("//*[@id='ctl00_MainContent_ctl02_rdgStudentScores_rfltMenu_detached']/ul/li[6]/span");
			
			//* Assert that the column values displayed under 'Math Scaled Score is equal  to 928 
			int i=0;
			while(isElementPresent("//*[@id='ctl00_MainContent_ctl02_rdgStudentScores_ctl00__"+i+"']/td[8]"))
			{
		     Assert.assertEquals(getText("//*[@id='ctl00_MainContent_ctl02_rdgStudentScores_ctl00__"+i+"']/td[8]"), "928");
		     i++;
			}
