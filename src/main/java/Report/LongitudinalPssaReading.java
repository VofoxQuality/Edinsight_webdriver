...
public class LongitudinalPssaReading extends BaseClassOne
{
	@Test(priority=1)
	public void TCED381901()
	{
		try
		{
			...
			click("//a[contains(text(),'Longitudinal PSSA Reading')]");
			
			//Assert the the Header Name as Longitudinal PSSA Reading Analysis
			Assert.assertEquals(getText("//td[@class='header-txt']"),"Longitudinal PSSA Reading Analysis");				
		} 
		catch (Exception e)
		{
	...
	public void TCED381904()
	{
		try
		{
			...
			//Assert the the Header Name as Longitudinal PSSA Reading Analysis
			Assert.assertEquals(getText("//span[@class='administitle']"),"Longitudinal PSSA Reading Analysis");				
		} 
		catch (Exception e)
		{
			Assert.fail(e.getMessage());
