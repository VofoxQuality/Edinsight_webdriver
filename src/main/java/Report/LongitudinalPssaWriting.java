...
public class LongitudinalPssaWriting extends BaseClassOne
{
	@Test(priority=1)
	public void TCED39701()
	{
		try
		{
			//Supertent Login
			...
			//Assert the the Header Name as Longitudinal PSSA Writing Analysis
	...
	@Test(priority=2)
	public void TCED39702()
	{
		try
		{
			//Application should be in the  Longitudinal PSSA Writing Report
	...
	public void TCED39704()
	{
		try
		{
			...
			//Assert the the Header Name as Longitudinal PSSA Writing Analysis
			//Assert.assertEquals(getText("//span[@class='administitle']"),"Longitudinal PSSA Writing Analysis");				
		} 
		catch (Exception e)
		{
			Assert.fail(e.getMessage());
	...
	@Test(priority=8)
	public void TCED39708()
	{
		try
		{
			//Application should be in the  Longitudinal PSSA Writing Report
			
			// Assert the longitudnal graph is present
			Assert.assertTrue(isElementPresent("//*[@id='ctl00_MainContent_ctl02_TelerikLineChart']"),"graph not displayed");
