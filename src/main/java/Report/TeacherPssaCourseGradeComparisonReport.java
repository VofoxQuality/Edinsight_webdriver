...
public class TeacherPssaCourseGradeComparisonReport extends BaseClassOne
{
	@Test(priority=1)
	public void TCED39801()
	{
		try
		{
			...
			//click PSSA Teacher ComparisonReport
			click("//tr[@id='ctl00_MainContent_ReportListSingleAssessment1_ctl00_trPssaTeacherComparison']//a[@class='header'][contains(text(),'Comparison')]");
